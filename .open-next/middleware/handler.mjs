...
var require_middleware = __commonJS({
  ".next/server/src/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[550], { 42: (a) => {
      ...
      "use strict";
      let d, e, f;
      c.r(b), c.d(b, { default: () => cv, handler: () => cu });
      var g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v = {};
      async function w() {
        return "_ENTRIES" in globalThis && _ENTRIES.middleware_instrumentation && await _ENTRIES.middleware_instrumentation;
      }
      c.r(v), c.d(v, { config: () => co, middleware: () => cn });
      let x = null;
      async function y() {
  ...
  `);
      ...
      function cn(a10) {
        if (a10.nextUrl.pathname.startsWith("/admin")) {
          ...
          if (b10) {
            let [a11, c2] = atob(b10.split(" ")[1]).split(":");
            if ("admin" === a11 && "password123" === c2) return ak.next();
          }
          return new ak("Auth Required", { status: 401, headers: { "WWW-Authenticate": 'Basic realm="Admin Portal"' } });
        }
        return ak.next();
      }
      RegExp("\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)"), RegExp("\\n\\s+at __next_metadata_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_viewport_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_outlet_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_validation_boundary__[\\n\\s]");
      let co = { matcher: ["/admin/:path*"] };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let cp = { ...v }, cq = "/src/middleware", cr = (0, cp.middleware || cp.default);
      class cs extends Error {
        constructor(a10) {
          super(a10), this.stack = "";
        }
      }
      if ("function" != typeof cr) throw new cs(`The Middleware file "${cq}" must export a function named \`middleware\` or a default function.`);
      let ct = (a10) => bJ({ ...a10, IncrementalCache: cl, incrementalCacheHandler: null, page: cq, handler: async (...a11) => {
        try {
          return await cr(...a11);
        } catch (e2) {
      ...
      async function cu(a10, b10) {
        let c2 = await ct({ request: { url: a10.url, method: a10.method, headers: N(a10.headers), nextConfig: { basePath: "", i18n: "", trailingSlash: false, experimental: { cacheLife: { default: { stale: 300, revalidate: 900, expire: 4294967294 }, seconds: { stale: 30, revalidate: 1, expire: 60 }, minutes: { stale: 300, revalidate: 60, expire: 3600 }, hours: { stale: 300, revalidate: 3600, expire: 86400 }, days: { stale: 300, revalidate: 86400, expire: 604800 }, weeks: { stale: 300, revalidate: 604800, expire: 2592e3 }, max: { stale: 300, revalidate: 2592e3, expire: 31536e3 } }, authInterrupts: false, clientParamParsingOrigins: [] } }, page: { name: cq }, body: "GET" !== a10.method && "HEAD" !== a10.method ? a10.body ?? void 0 : void 0, waitUntil: b10.waitUntil, requestMeta: b10.requestMeta, signal: b10.signal || new AbortController().signal } });
...
var BuildId = "WMhLxFtIxg7S8pS37O5BK";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "entrypoint": "server/src/middleware.js", "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/admin/:path*" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "WMhLxFtIxg7S8pS37O5BK", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "n4G1eC2e7lITE7h08tHOHGNUYuiEPou31P0zr5f+4Qw=", "__NEXT_PREVIEW_MODE_ID": "c2ebe2a23b3eee485844474241234feb", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5bcf28e91fd85b9db1c16bc629b028ea3dfe89ff63e59d523c6ecf84f025d2e5", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "e197139241ab45a2c33e9b21652ed83de019cf28eeea802d5b1e539c9a345935" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/_global-error/page": "/_global-error", "/api/ingest/route": "/api/ingest", "/favicon.ico/route": "/favicon.ico", "/[[...slug]]/page": "/[[...slug]]" };
